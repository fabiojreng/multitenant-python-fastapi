...
from app.application.use_cases.category.find_category_id_use_case import FindCategoryIdUseCase
from app.application.use_cases.category.list_categories_use_case import ListCategoriesUseCase
...
def create_category(request: Request, category_data: CategoryCreateSchema):
    print(category_data.model_dump())
...
@router.get("/category/{category_id}", response_model=SchemaResponseHttp,
...
@router.get("/categories/", response_model=SchemaResponseHttp,
